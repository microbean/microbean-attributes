 ...
 */
public final record DoubleValue(double value) implements Value<DoubleValue> {

  @Override // Comparable<DoubleValue>
  ...
  @Override // Constable
  public final Optional<DynamicConstantDesc<DoubleValue>> describeConstable() {
